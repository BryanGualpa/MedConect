...
// SCRUM-41 | HU-04 | Subtarea: Crear pages/AgendarCita.jsx modal de confirmación
// RF-06: Confirmación con número único | RF-07: Correo y recordatorio automático
...
export default function AgendarCita() {
  ...
  // RF-06: Pantalla de éxito con número único de cita
  if (exito) {
    return (
      <div className="container mc-page">
